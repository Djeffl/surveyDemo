...
@Component({
  ...
  styleUrl: './survey-taker.component.scss',
...
export class SurveyTakerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // theme configurator https://surveyjs.io/create-free-survey
    survey.applyTheme({
      backgroundImage: '',
      ...
      cssVariables: {
        ...
        '--sjs-primary-backcolor': '#ffcf24',
        '--sjs-primary-backcolor-light': 'rgba(255, 207, 36, 0.1)',
        '--sjs-primary-backcolor-dark': 'rgba(240, 195, 34, 1)',
